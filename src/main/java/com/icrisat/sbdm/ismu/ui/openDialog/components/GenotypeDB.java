...
import com.icrisat.sbdm.ismu.ui.openDialog.components.loginPanel.GerminateLoginPanel;
import com.icrisat.sbdm.ismu.ui.openDialog.components.loginPanel.GigwaLoginPanel;
...
public class GenotypeDB {
    ...
    public void createGenotypeDB() {
        ...
        dialogBox.setSize(new Dimension(500, 250));
