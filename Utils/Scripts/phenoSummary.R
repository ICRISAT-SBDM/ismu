...
source(paste(oldwd, "/Utils/Scripts/BasicStats.R", sep=""))
...
# Write Time and Logo
#TRes<-HTML("<hr/>", file=FilePhSUM, Append=T)
TRes<-HTML(paste("<p align=left>Results Generated by ISMU 3.0 : ", format(Sys.time(), "%a %b %d %X %Y")), file=FilePhSUM, Append=T)
